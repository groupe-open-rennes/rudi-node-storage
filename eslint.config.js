...
export default [
  {
    ...
    rules: {
      ...
      // "no-undef-init": 0,
      // "no-undefined": 0,
      'no-unused-vars': 0, // [1, { args: 'none' }], // eslint:recommended
      ...
      // "array-bracket-spacing": [0, "always", { "objectsInArrays": false, "arraysInArrays": false }], // Prettier
      'array-element-newline': 0, // eslint:recommended
      'block-spacing': [1, 'always'],
      // "brace-style": [0, "stroustrup", { "allowSingleLine": true }], // Prettier
      camelcase: [1, { properties: 'never' }],
      // "capitalized-comments": 0,
      // "comma-dangle": [0, "never"], // prettier
      'comma-spacing': 1,
      'comma-style': 2,
      ...
      // "id-length": 0,
      // "id-match": 0,
      // "indent": [0,4,{"CallExpression": { "arguments": 2 },"FunctionDeclaration": { "body": 1, "parameters": 2 },"FunctionExpression": { "body": 1, "parameters": 2 },"MemberExpression": 2,"ObjectExpression": 1,"SwitchCase": 0,"ignoredNodes": ["ConditionalExpression"]}], // Prettier
      // "jsx-quotes": 0,
      'key-spacing': 0,
      'keyword-spacing': 1,
      ...
      // "max-depth": 0,
      // "max-len": [0,{"code": 280,"tabWidth": 4,"ignoreUrls": true,"ignorePattern": "goog\\.(module|require)"}], // Prettier
      // "max-lines": 0,
      ...
      // "quotes": [0, "single", { "allowTemplateLiterals": true }], // Prettier
      ...
      'unused-imports/no-unused-vars': [
        'warn',
        {
          args: 'after-used', // only the last argument must be used. This allows you, for instance, to have two named parameters to a function and as long as you use the second argument, ESLint will not warn you about the first. This is the default setting.
          argsIgnorePattern: '^(_|req|reply|res|next|err)$',
          vars: 'all',
